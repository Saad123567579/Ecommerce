      ...
      <div className="pt-6">
        ...
        <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <p className="text-3xl tracking-tight strike text-gray-900 line-through">${price}</p>
            <p className="text-3xl tracking-tight strike text-gray-900">${Math.round(price - (discountPercentage / 100) * price)}</p>
            <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 my-2 px-4 rounded" onClick={handleClick} >Add to Cart</button>
